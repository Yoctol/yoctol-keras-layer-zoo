from .RNN.test_rnn_base import TestRNNBaseClass
from .convolution.test_base2D import TestBase2DClass
from .convolution.test_base3D import TestBase3DClass
from .convolution.test_conv_base2D import TestConvBase2DClass
from .convolution.test_conv_base3D import TestConvBase3DClass
